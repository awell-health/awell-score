import type { MiniBestSectionType } from '../../../src/types/calculations/subscales/custom/mini_best.types'

/**
 * "Section" is a synonym for "Subscale"
 */
export const MINI_BEST_TEST_SECTIONS: Array<MiniBestSectionType> = [
  {
