import type { COMIDomainType } from '../../../../src/types/calculations/subscales/custom/comi.types'
import {
...
export const COMI_NECK_DOMAINS: Array<COMIDomainType> = [
  {
    id: 'PAIN',
