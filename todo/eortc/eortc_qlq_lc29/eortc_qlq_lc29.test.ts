...
import { ZodError } from '../../../src/calculation_suite/errors'
...
describe('eortc_qlq_lc29', function () {
  it('eortc_qlq_lc29 calculation function should be available as a calculation', function () {
    expect(CALCULATIONS).toHaveProperty('eortc_qlq_lc29')
  })
  ...
  describe('the score includes the correct input fields', function () {
    it('should have all the expected input ids configured', function () {
      ...
      expect(EXPECTED_ITEM_NUMBERS).toEqual(configured_input_ids)
    })
