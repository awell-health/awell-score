...
import {
  ADDITIONAL_INPUTS,
  EORTC_QLQ_LC29_OUTPUT,
  EORTC_QLQ_LC29_SCALES,
} from './definition'

const calculate_eortc_lc29_scale_scores = (
...
export const specific_steps_eortc_qlq_lc29_calc = [
  calculate_eortc_lc29_scale_scores,
]

export const eortc_qlq_lc29: CalculationType = create_calculation({
  calculation_name: 'EORTC-QLQ-LC29',
  readme_location: __dirname,
  calculation_steps: specific_steps_eortc_qlq_lc29_calc,
  calculation_definition: {
    input_definition: EORTC_QLQ_LC29_SCALES,
    output_definition: EORTC_QLQ_LC29_OUTPUT,
  },
