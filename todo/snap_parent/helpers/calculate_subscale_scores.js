...
import { SNAP_SUBSCALES, type SubscaleType } from '../definition/snap_subscales'
import {
  inputIdLens,
  rawInputValueLens
...
export const calculate_subscale_scores = (
  ...
  const INPUT_IDS_NEEDED_FOR_SCORING = SNAP_SUBSCALES[subscale]
  ...
  return R.sum(valid_answers_in_subscale)
}
