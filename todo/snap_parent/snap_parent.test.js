...
const snap_calculation = execute_test_calculation(snap_parent)

describe('snap parent', function () {
  it('snap calculation function should be available as a calculation', function () {
    expect(CALCULATIONS).to.include.key('snap_parent')
  })
    ...
    describe('when called with an empty response', function () {
      ...
      describe('INATTENTION_SUBSET', function () {
        it('should return missing for the result status and undefined score', function () {
          const score = view_result('SNAP_PARENT_INATTENTION_SCORE')(outcome)
          const status = view_status('SNAP_PARENT_INATTENTION_SCORE')(outcome)
      ...
      describe('OPPOSITION_DEFIANCE_SUBSET', function () {
        it('should return missing for the result status and undefined score', function () {
          console.log('ROBO ', outcome)
          const score = view_result('SNAP_PARENT_OPPOSITION_DEFIANCE_SCORE')(
            outcome
          )
          const status = view_status('SNAP_PARENT_OPPOSITION_DEFIANCE_SCORE')(
            outcome
          )
