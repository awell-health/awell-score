...
export const specific_steps_fjs_12_hip_calc = [
  calculate_fjs_12_score,
  add_raw_values_to_inputs(FJS_HIP_INPUTS),
]

export const forgotten_joint_score_hip: CalculationType = create_calculation({
  calculation_name: 'Forgotten Joint Score – 12 (FJS-12) - Hip',
  readme_location: __dirname,
  calculation_steps: specific_steps_fjs_12_hip_calc,
  calculation_definition: {
    input_definition: FJS_HIP_INPUTS,
    output_definition: FJS_HIP_OUTPUT,
  },
})
