...
import { FJS_KNEE_INPUTS } from './definition'
...
const fjs_calculation = execute_test_calculation(forgotten_joint_score_knee)
...
describe('forgotten_joint_score_knee', function () {
  it('forgotten_joint_score_knee calculation function should be available as a calculation', function () {
    expect(CALCULATIONS).toHaveProperty('forgotten_joint_score_knee')
  })
  ...
  describe('validation', function () {
    describe('the score includes the correct input fields', function () {
      it('should have all the expected input ids configured', function () {
        ...
        const configured_input_ids =
          get_input_ids_from_calculation_blueprint(FJS_KNEE_INPUTS)
    ...
    describe('when called with an empty response', function () {
      it('should return undefined result as the score and a missing status', function () {
        ...
        const score = view_result('FORGOTTEN_JOINT_SCORE_KNEE')(outcome)
  ...
  describe('score calculation', function () {
    describe('when called with the best response', function () {
      it('should return the best FJS score', function () {
        ...
        expect(score).toEqual(BEST_FJS_SCORE)
      })
    })
    ...
    describe('when called with the median response', function () {
      it('should return the median FJS score', function () {
        ...
        expect(score).toEqual(MEDIAN_FJS_SCORE)
      })
    })
    ...
    describe('when called with the worst response', function () {
      it('should return the worst FJS score', function () {
        ...
        expect(score).toEqual(WORST_FJS_SCORE)
      })
    })
