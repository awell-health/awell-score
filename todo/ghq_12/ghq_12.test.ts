...
describe('ghq_12', function () {
  it('ghq_12 calculation function should be available as a calculation', function () {
    expect(CALCULATIONS).toHaveProperty('ghq_12')
  })
  ...
  describe('score calculation', function () {
    describe('when called with the worst response', function () {
      it('should return the worst score', function () {
        ...
        expect(score).toEqual(GHQ_12_WORST_SCORE)
      })
    })
    ...
    describe('when called with a median response', function () {
      it('should return the median score', function () {
        ...
        expect(score).toEqual(GHQ_12_MEDIAN_SCORE)
      })
    })
    ...
    describe('when called with a maximum response', function () {
      it('should return the maximum score', function () {
        ...
        expect(score).toEqual(GHQ_12_BEST_SCORE)
      })
    })
