...
describe('difference_calc', function () {
  it('difference_calc calculation function should be available as a calculation', function () {
    expect(CALCULATIONS).toHaveProperty('difference_calc')
  })
  ...
  describe('validation', function () {
    ...
    describe('when called with an empty response', function () {
      ...
      it('should return undefined result as the score', function () {
        ...
        expect(absolute_difference).toEqual(undefined)
        expect(increase).toEqual(undefined)
      })
      ...
      it('should return MISSING as the status', function () {
        ...
        expect(absolute_difference).toEqual(MISSING_STATUS)
        expect(increase).toEqual(MISSING_STATUS)
      })
    })
  })
  ...
  describe('score calculation', function () {
    describe('when the values are 0', function () {
      it('should work', function () {
        ...
        expect(absolute_difference).toEqual(0)
        expect(increase).toEqual(0)
      })
    })
    ...
    describe('when there is a positive difference', function () {
      it('should work', function () {
        ...
        expect(absolute_difference).toEqual(5)
        expect(increase).toEqual(100)
      })
    })
    ...
    describe('when there is a negative difference', function () {
      it('should work', function () {
        ...
        expect(absolute_difference).toEqual(-423)
        expect(increase).toEqual(-92.5601750547046)
      })
    })
  })
})
