...
const calculate_scores = (
  ...
  return [
    {
      id: 'SNAP_TEACHER_INATTENTION_SCORE',
      score: INATTENTION_SUBSET_SCORE
    },
    {
      id: 'SNAP_TEACHER_INATTENTION_SCORE_INTERPRETATION',
      score:
        SNAP_INTERPRETATION_TABLE[INATTENTION_SUBSET_SCORE.toString()] ??
        MISSING_MESSAGE
    },
    {
      id: 'SNAP_TEACHER_HYPERACTIVITY_IMPULSIVITY_SCORE',
      score: HYPERACTIVITY_IMPULSIVITY_SUBSET_SCORE
    },
    {
      id: 'SNAP_TEACHER_HYPERACTIVITY_IMPULSIVITY_SCORE_INTERPRETATION',
      score:
        SNAP_INTERPRETATION_TABLE[
    ...
    {
      id: 'SNAP_TEACHER_OPPOSITION_DEFIANCE_SCORE',
      score: OPPOSITION_DEFIANCE_SUBSET_SCORE
    },
    {
      id: 'SNAP_TEACHER_OPPOSITION_DEFIANCE_SCORE_INTERPRETATION',
      score:
        SNAP_OPPOSITION_DEFIANCE_INTERPRETATION_TABLE[
...
export const snap_teacher: CalculationType = create_calculation({
  calculation_name: 'SNAP-IV 26-Item Teacher Rating Scale (SNAP)',
  readme_location: __dirname,
  calculation_steps: specific_steps_snap_calc,
  calculation_definition: {
    input_definition: SNAP_INPUTS,
    output_definition: SNAP_TEACHER_OUTPUT
  }
})
