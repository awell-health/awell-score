...
describe('pcl_5', function () {
  it('pcl_5 calculation function should be available as a calculation', function () {
    expect(CALCULATIONS).toHaveProperty('pcl_5')
  })
    ...
    describe('when called with the worst response', function () {
      ...
      describe('Total Symptom Severity Score', function () {
        it('should return the worst score', function () {
          ...
          expect(score).toEqual(PCL5_WORST_SCORE)
        })
      })
      describe('DSM-5 Symptom Cluster B (items 1-5)', function () {
        it('should return the worst score', function () {
          ...
          expect(score).toEqual(WORST_SCORE_CLUSTER_B)
        })
      })
      describe('DSM-5 Symptom Cluster C (items 6-7)', function () {
        it('should return the worst score', function () {
          ...
          expect(score).toEqual(WORST_SCORE_CLUSTER_C)
        })
      })
      describe('DSM-5 Symptom Cluster D (items 8-14)', function () {
        it('should return the worst score', function () {
          ...
          expect(score).toEqual(WORST_SCORE_CLUSTER_D)
        })
      })
      describe('DSM-5 Symptom Cluster E (items 15-20)', function () {
        it('should return the worst score', function () {
          ...
          expect(score).toEqual(WORST_SCORE_CLUSTER_E)
        })
      })
      describe('PTSS Indication (based on DSM-5 diagnostic rule)', function () {
    ...
    describe('when called with a median response', function () {
      ...
      describe('Total Symptom Severity Score', function () {
        it('should return the median score', function () {
          ...
          expect(score).toEqual(PCL5_MEDIAN_SCORE)
        })
      })
      describe('DSM-5 Symptom Cluster B (items 1-5)', function () {
        it('should return the median score', function () {
          ...
          expect(score).toEqual(MEDIAN_SCORE_CLUSTER_C)
        })
      })
      describe('DSM-5 Symptom Cluster C (items 6-7)', function () {
        it('should return the median score', function () {
      ...
      describe('DSM-5 Symptom Cluster D (items 8-14)', function () {
        it('should return the median score', function () {
          ...
          expect(score).toEqual(MEDIAN_SCORE_CLUSTER_D)
        })
      })
      describe('DSM-5 Symptom Cluster E (items 15-20)', function () {
        it('should return the median score', function () {
          ...
          expect(score).toEqual(MEDIAN_SCORE_CLUSTER_E)
        })
      })
      describe('PTSS Indication (based on DSM-5 diagnostic rule)', function () {
        it('should return true', function () {
    ...
    describe('when called with the best response', function () {
      ...
      describe('Total Symptom Severity Score', function () {
        it('should return the best score', function () {
          ...
          expect(score).toEqual(PCL5_BEST_SCORE)
        })
      })
      describe('DSM-5 Symptom Cluster B (items 1-5)', function () {
        it('should return the best score', function () {
