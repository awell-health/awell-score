...
describe('snap teacher', function () {
  ...
  describe('validation', function () {
    ...
    describe('when called with an empty response', function () {
      ...
      describe('INATTENTION_SUBSET', function () {
        it('should return null for the result and the interpretation', function () {
          expect(outcome.SNAP_TEACHER_INATTENTION_SCORE).toEqual(null)
          expect(outcome.SNAP_TEACHER_INATTENTION_SCORE_INTERPRETATION).toEqual(
            null,
          )
        })
      })
      ...
      describe('HYPERACTIVITY_IMPULSIVITY_SUBSET', function () {
        it('should return null for the result and the interpretation', function () {
          expect(outcome.SNAP_TEACHER_HYPERACTIVITY_IMPULSIVITY_SCORE).toEqual(
            null,
          )
          expect(
            outcome.SNAP_TEACHER_HYPERACTIVITY_IMPULSIVITY_SCORE_INTERPRETATION,
          ).toEqual(null)
        })
      })
      ...
      describe('OPPOSITION_DEFIANCE_SUBSET', function () {
        it('should return null for the result and the interpretation', function () {
          expect(outcome.SNAP_TEACHER_OPPOSITION_DEFIANCE_SCORE).toEqual(null)
          expect(
            outcome.SNAP_TEACHER_OPPOSITION_DEFIANCE_SCORE_INTERPRETATION,
          ).toEqual(null)
        })
      })
    })
    ...
    describe('when called with the worst response', function () {
      ...
      describe('INATTENTION_SUBSET', function () {
        it('should return the worst score', function () {
          expect(outcome.SNAP_TEACHER_INATTENTION_SCORE).toEqual(27)
          expect(outcome.SNAP_TEACHER_INATTENTION_SCORE_INTERPRETATION).toEqual(
            'Severe symptoms',
          )
        })
      ...
      describe('OPPOSITION_DEFIANCE_SUBSET', function () {
        it('should return the worst score', function () {
          expect(outcome.SNAP_TEACHER_OPPOSITION_DEFIANCE_SCORE).toEqual(24)
          expect(
            outcome.SNAP_TEACHER_OPPOSITION_DEFIANCE_SCORE_INTERPRETATION,
          ).toEqual('Severe symptoms')
        })
    ...
    describe('when called with the best response', function () {
      ...
      describe('INATTENTION_SUBSET', function () {
        it('should return the best score', function () {
          expect(outcome.SNAP_TEACHER_INATTENTION_SCORE).toEqual(0)
          expect(outcome.SNAP_TEACHER_INATTENTION_SCORE_INTERPRETATION).toEqual(
      ...
      describe('OPPOSITION_DEFIANCE_SUBSET', function () {
        it('should return the best score', function () {
          expect(outcome.SNAP_TEACHER_OPPOSITION_DEFIANCE_SCORE).toEqual(0)
          expect(
            outcome.SNAP_TEACHER_OPPOSITION_DEFIANCE_SCORE_INTERPRETATION,
          ).toEqual('Symptoms not clinically significant')
        })
    ...
    describe('when called with the random response', function () {
      ...
      describe('INATTENTION_SUBSET', function () {
        it('should return the exepected score', function () {
          expect(outcome.SNAP_TEACHER_INATTENTION_SCORE).toEqual(11)
          expect(outcome.SNAP_TEACHER_INATTENTION_SCORE_INTERPRETATION).toEqual(
            'Symptoms not clinically significant',
          )
        })
      ...
      describe('OPPOSITION_DEFIANCE_SUBSET', function () {
        it('should return the exepected score', function () {
          expect(outcome.SNAP_TEACHER_OPPOSITION_DEFIANCE_SCORE).toEqual(9)
          expect(
            outcome.SNAP_TEACHER_OPPOSITION_DEFIANCE_SCORE_INTERPRETATION,
          ).toEqual('Mild symptoms')
        })
