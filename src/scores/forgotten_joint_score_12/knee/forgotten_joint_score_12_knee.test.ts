...
import {
  ...
  random_response,
  worst_response,
} from './__testdata__/forgotten_joint_score_12_knee_test_responses'
import { forgotten_joint_score_knee } from './forgotten_joint_score_knee_12'

const BEST_FJS_SCORE = 100
const MEDIAN_FJS_SCORE = 50
const WORST_FJS_SCORE = 0

const fjs_calculation = new Score(forgotten_joint_score_knee)

describe('forgotten_joint_score_knee', function () {
  it('forgotten_joint_score_knee calculation function should be available as a calculation', function () {
    expect(ScoreLibrary).toHaveProperty('forgotten_joint_score_knee')
  })
  ...
  describe('basic assumptions', function () {
    ...
    it('should have the expected calculation result id', function () {
      const EXPECTED_CALCULATION_ID = ['FORGOTTEN_JOINT_SCORE_KNEE']
  ...
  describe('validation', function () {
    ...
    describe('when called with an empty response', function () {
      it('should return null result', function () {
        ...
        expect(outcome.FORGOTTEN_JOINT_SCORE_KNEE).toEqual(null)
      })
    })
  })
  ...
  describe('score calculation', function () {
    describe('when called with the best response', function () {
      it('should return the best FJS score', function () {
        const outcome = fjs_calculation.calculate({ payload: best_response })
        expect(outcome.FORGOTTEN_JOINT_SCORE_KNEE).toEqual(BEST_FJS_SCORE)
      })
    })
    ...
    describe('when called with the median response', function () {
      it('should return the median FJS score', function () {
        ...
        expect(outcome.FORGOTTEN_JOINT_SCORE_KNEE).toEqual(MEDIAN_FJS_SCORE)
      })
    })
    ...
    describe('when called with the worst response', function () {
      it('should return the worst FJS score', function () {
        ...
        expect(outcome.FORGOTTEN_JOINT_SCORE_KNEE).toEqual(WORST_FJS_SCORE)
      })
    })
    ...
    describe('when called with a random response', function () {
      it('should return the expected FJS score', function () {
        ...
        expect(outcome.FORGOTTEN_JOINT_SCORE_KNEE).toEqual(EXPECTED_SCORE)
      })
    })
