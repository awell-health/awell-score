...
describe('visa_p', function () {
  ...
  describe('the score includes the correct input fields', function () {
    it('should use the correct input fields', function () {
      ...
      const configured_calculation_input_ids = Object.keys(
        visa_p_calculation.inputSchema,
      )
  ...
  describe('each calculated score includes the correct output result and correct score title', function () {
    const outcome = visa_p_calculation.calculate({ payload: min_response })
    ...
    it('should have the correct calculation id', function () {
      ...
      expect(configured_calculation_id).toEqual(['VISA_P'])
    })
  })
  ...
  describe('each calculated score includes the correct formula and outputs the correct result', function () {
    describe('when a minimum response is passed', function () {
      it('should return the minimum score', function () {
        const score = visa_p_calculation.calculate({ payload: min_response })

        expect(score.VISA_P).toEqual(VISA_P_MIN_SCORE)
      })
    })

    describe('when a median response is passed', function () {
      it('should return the median score', function () {
        const score = visa_p_calculation.calculate({
    ...
    describe('when a maximum response is passed', function () {
      it('should return the maximum score', function () {
        ...
        expect(score.VISA_P).toEqual(VISA_P_MAX_SCORE)
      })
    })
    ...
    describe('when a random response is passed', function () {
      it('should return the expected score', function () {
        ...
        expect(score.VISA_P).toEqual(EXPECTED_SCORE)
      })
    })
  })
  ...
  describe('a score is only calculated when all mandatory fields are entered', function () {
    describe('when an empty response is passed', function () {
      it('should throw a ZodError', function () {
        expect(() => visa_p_calculation.calculate({ payload: {} })).toThrow(
          ZodError,
        )
      })
    })
