...
const beck_calculation = new Calculation(beck)
  ...
  describe('validation', function () {
    ...
    describe('when called with an empty', function () {
      it('should throw an error', function () {
        expect(() => beck_calculation.calculate({ payload: {} })).to.throw(
          ZodError
        )
      })
    })
  ...
  describe('score calcualtion', function () {
    describe('when called with a minimum response', function () {
      it('should return the minimum score', function () {
        ...
        expect(score.beck).to.eql(BECK_MIN_SCORE)
      })
    })
    ...
    describe('when called with a median response', function () {
      it('should return the median score', function () {
        ...
        expect(score.beck).to.eql(BECK_MEDIAN_SCORE)
      })
    })
    ...
    describe('when called with a maximum response', function () {
      it('should return the maximum score', function () {
        ...
        expect(score.beck).to.eql(BECK_MAX_SCORE)
      })
    })
    describe('when called with a random response', function () {
      it('should return the expected score', function () {
        ...
        expect(score.beck).to.eql(EXPECTED_SCORE)
      })
    })
  })
})
