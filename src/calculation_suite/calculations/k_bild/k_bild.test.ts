...
describe('k_bild', function () {
  it('k_bild calculation function should be available as a calculation', function () {
    expect(CALCULATIONS).to.have.property('k_bild')
  })
  ...
  describe('validation', function () {
    ...
    describe('Psychological domain has correct input fields', function () {
      it('should be true', function () {
        ...
        expect(EXPECTED_INPUT_IDS).to.eql(KBILD_DOMAINS.PSYCHOLOGICAL)
      })
    })
    ...
    describe('Chest symptoms domain has correct input fields', function () {
      it('should be true', function () {
        ...
        expect(EXPECTED_INPUT_IDS).to.eql(KBILD_DOMAINS.CHEST_SYMPTOMS)
      })
    })
    ...
    describe('when called with the worst response', function () {
      ...
      describe('Total score (raw)', function () {
        it('should return the worst score', function () {
          ...
          expect(score).to.eql(KBILD_RAW_WORST_SCORE)
        })
      })
      describe('Breathlessness and activities domain (transformed)', function () {
        it('should return the worst score', function () {
          ...
          expect(score).to.eql(KBILD_TRANSFORMED_WORST_SCORE)
        })
      })
      describe('Psychological domain (transformed)', function () {
        it('should return the worst score', function () {
    ...
    describe('when called with a median response', function () {
      ...
      describe('Total score (raw)', function () {
        it('should return the median score', function () {
          ...
          expect(score).to.eql(KBILD_RAW_MEDIAN_SCORE)
        })
      })
      describe('Breathlessness and activities domain (transformed)', function () {
        it('should return the median score', function () {
          ...
          expect(score).to.eql(KBILD_TRANSFORMED_MEDIAN_SCORE)
        })
      })
      describe('Psychological domain (transformed)', function () {
        it('should return the median score', function () {
    ...
    describe('when called with the best response', function () {
      ...
      describe('Total score (raw)', function () {
        it('should return the best score', function () {
          ...
          expect(score).to.eql(KBILD_RAW_BEST_SCORE)
        })
      })
      describe('Breathlessness and activities domain (transformed)', function () {
        it('should return the best score', function () {
          ...
          expect(score).to.eql(KBILD_TRANSFORMED_BEST_SCORE)
        })
      })
      describe('Psychological domain (transformed)', function () {
        it('should return the best score', function () {
