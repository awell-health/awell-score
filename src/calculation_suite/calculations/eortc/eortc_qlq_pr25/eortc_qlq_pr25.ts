...
import { EORTC_QLQ_PR25_OUTPUT, EORTC_QLQ_PR25_SCALES } from './definition'

const calculate_eortc_pr25_scale_scores = (
...
export const specific_steps_eortc_qlq_pr25_calc = [
  calculate_eortc_pr25_scale_scores,
]

export const eortc_qlq_pr25: CalculationType = create_calculation({
  calculation_name: 'EORTC-QLQ-PR25',
  readme_location: __dirname,
  calculation_steps: specific_steps_eortc_qlq_pr25_calc,
  calculation_definition: {
    input_definition: EORTC_QLQ_PR25_SCALES,
    output_definition: EORTC_QLQ_PR25_OUTPUT,
  },
})
