...
describe('isi', function () {
  it('isi calculation function should be available as a calculation', function () {
    expect(CALCULATIONS).to.have.property('isi')
  })
    ...
    describe('when called with the worst response', function () {
      ...
      describe('Total score', function () {
        it('should return the worst score', function () {
          ...
          expect(score).to.eql(ISI_WORST_SCORE)
        })
      })
      describe('Interpretation', function () {
        it('should return the worst interpretation', function () {
          ...
          expect(score).to.eql('Clinical insomnia (severe)')
        })
      })
    })
    ...
    describe('when called with a median response', function () {
      ...
      describe('Total score', function () {
        it('should return the median score', function () {
          ...
          expect(score).to.eql(ISI_MEDIAN_SCORE)
        })
      })
      describe('Interpretation', function () {
        it('should return the median interpretation', function () {
          ...
          expect(score).to.eql('Subthreshold insomnia')
        })
      })
    })
    ...
    describe('when called with the best response', function () {
      ...
      describe('Total score', function () {
        it('should return the best score', function () {
          ...
          expect(score).to.eql(ISI_BEST_SCORE)
        })
      })
      describe('Interpretation', function () {
        it('should return the best interpretation', function () {
          ...
          expect(score).to.eql('No clinically significant insomnia')
        })
      })
    })
